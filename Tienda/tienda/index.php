    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/imagen10.jpg" alt="imagen10">
                <div class="carousel-caption">
                    Text Slider 1
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/imagen0.jpg" alt="imagen0">
                <div class="carousel-caption">
                    Text Slider 2
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/imagen4.jpg" alt="imagen4">
                <div class="carousel-caption">
                    Text Slider 3
                </div>
            </div>
...
<!-- -   .....      mi codigo de mejora                -->
    ...
    <div class="row" style="margin-top: 20px;">
        <div class="col-md-4">
            <a href="products.php?categoria=varones" class="btn btn-success btn-lg btn-block">
                <i class="fa fa-male"></i> Varones
            </a>
        </div>
        <div class="col-md-4">
            <a href="products.php?categoria=mujeres" class="btn btn-danger btn-lg btn-block">
                <i class="fa fa-female"></i> Mujeres
            </a>
        </div>
        <div class="col-md-4">
            <a href="products.php?categoria=niños" class="btn btn-primary btn-lg btn-block">
                <i class="fa fa-child"></i> Niños
            </a>
        </div>
    </div>
</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/ddavid.png" alt="Smart-TV" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
